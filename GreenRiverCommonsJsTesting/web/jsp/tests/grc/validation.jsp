...
<html>
    <head>
        ...
        <script type="text/javascript" src="${jsRoot}/grc/debug.js"></script>
        <script type="text/javascript" src="${jsRoot}/grc/validation.js"></script>
        <script type="text/javascript" src="${jsRoot}/jsunit/app/jsUnitCore.js"></script>
        <script type="text/javascript" src="${jsRoot}/tests/grc/validation.js"></script>
        <script type="text/javascript">
